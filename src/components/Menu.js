            ...
            <div className='flex'>
                <div className='w-[16.66%] inline-block'>
                    <div className='p-[10px]'>
                        <img src={`image/bride-logo.png`} alt="logo" />
                    </div>
                                            ...
                                            <ul>
                                                {currentSubMenu.map((submenuItem) => (
                                                    <li key={submenuItem.id}
                                                        ...
                                                        className={`py-[12px] px-[36px] ${submenuItem.attributes.title === submenutitle ? "bg-[#9E0851] text-white" : "text-[#767171]"}`}

                                                    >
                                                        <Link to={submenuItem.attributes.url} className='text-[15px] font-semibold whitespace-nowrap'>{submenuItem.attributes.title} {submenuItem.attributes.children.data.length !== 0 && <ChevronRightIcon className="w-3 h-3 inline-block" />}</Link>
                                                        {currentSubSubMenu.length !== 0 && showSubSubMenu && submenuItem.attributes.title === submenutitle && (
                                                            <div className=" absolute left-[146px] top-5 bg-white shadow-lg rounded-lg z-20">
                                                                <ul>
                                                                    {currentSubSubMenu.map((submenuItem) => (
                                                                        <li key={submenuItem.id}
                                                                            ...
                                                                            className={`py-[12px] px-[36px] ${submenuItem.attributes.title === subSubMenutitle ? "bg-[#9E0851] text-white" : "text-[#767171]"}`}>
                                                                            <Link to={submenuItem.attributes.url} className='text-[15px] font-semibold whitespace-nowrap'>{submenuItem.attributes.title}</Link>
                                                                        </li>
                                                                    ))}
                                                                </ul>
                                                            </div>
                ...
                <div className='w-[16.66%] p-[10px] flex items-end'>
                    <div className='p-[16px] flex-grow'>
                        <div className='text-right'>
                            <Link to="" className='bg-[#9E0851] py-[15px] px-[30px] text-white text-base font-semibold rounded'>Exhibit</Link>
                        </div>
                    </div>
                </div>
            </div> 
